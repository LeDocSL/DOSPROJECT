...
if len(sys.argv) == 1:
    sys.exit('Usage: ' + sys.argv[0] + ' ip port(0=random) time((0=forever) byte(65500)')
...
def udpsend():
    ...
    print("SLAMMING KIDS: %s:%s: for %s seconds with 65500 packets son" % (ip, port, dur or 'infinite'))
