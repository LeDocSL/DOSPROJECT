...
sys.stdout.write("\x1b]2;DOC\x07")


def modifications():
    print("Contact DOC the script is currently under maitnance")
...
info = """
[\033[91mDOC\033[00m] \033[91mDOCSTYLE, Made with love use properly ;)
"""
...
║ \033[00mExit                          \033[91m|\033[00m EXIT DOC \033[91m         ║
║ \033[00mMethods                       \033[91m|\033[00m DOC METHODS\033[91m         ║
║ \033[00mTools                         \033[91m|\033[00m BASIC TOOLS\033[91m          ║
║ \033[00mUpdates                       \033[91m|\033[00m DISPLAY UPDATE NOTES\033[91m ║
║ \033[00mInfo                          \033[91m|\033[00m DISPLAY DOC INFO\033[91m ║
╚══════════════════════════════════════════════════════╝\033[00m
"""
...
║ \033[00mStats                         \033[91m|\033[00m DISPLAY DOC STATS\033[91m║
╚══════════════════════════════════════════════════════╝\033[00m
"""
...
def main():
    ...
    while True:
        sys.stdout.write("\x1b]2;DOC\x07")
        sin = input("\033[1;00m[\033[91mDOC\033[1;00m]-\033[91mSTYLE\033[00m ").lower()
        sinput = sin.split(" ")[0]
        if sinput == "clear":
            os.system("clear")
            main()
            ...
            def scan(port, ip):
                try:
                    ...
                    print("[\033[91mDOC\033[00m] {}\033[91m:\033[00m{} [\033[91mOPEN\033[00m]".format(ip, port))
                    sock.close()
                except socket.error:
                    return
            ...
            print("\n[\033[91mDOC\033[00m] UPD Running processes: {}".format(uaid))
            print("[\033[91mDOC\033[00m] ICMP Running processes: {}".format(iaid))
            print("[\033[91mDOC\033[00m] SYN Running processes: {}".format(said))
            print("[\033[91mDOC\033[00m] STD Running Processes: {}".format(said))
            print("[\033[91mDOC\033[00m] Total attacks running: {}\n".format(aid))
            main()
        elif sinput == "dnsresolve":
            sfound = 0
            sys.stdout.write("\x1b]2;DOC |{}| F O U N D\x07".format(sfound))
            try:
                host = sin.split(" ")[1]
                with open(r"subnames.txt", "r") as sub:
                ...
                for link in domains:
                    try:
                        ...
                        print(
                            "[\033[91mDOC\033[00m] Domain: https://{} \033[91m>\033[00m Converted: {} [\033[91mEXISTANT\033[00m]".format(
                                url, subips))
                        sfound += 1
                        fsubs += 1
                        sys.stdout.write("\x1b]2;DOC |{}| F O U N D\x07".format(sfound))
                        ...
                        pass
                print("[\033[91mDOC\033[00m] Task complete | found: {}".format(sfound))
                main()
            except IndexError:
                print('ADD THE HOST!')
        elif sinput == "resolve":
            ...
            print("[\033[91mDOC\033[00m] Host: {} \033[00m[\033[91mConverted\033[00m] {}".format(host, host_ip))
            main()
        elif sinput == "ping":
            tpings += 1
            try:
                sinput, host, port = sin.split(" ")
                print("[\033[91mDOC\033[00m] Starting ping on host: {}".format(host))
                try:
                    ip = socket.gethostbyname(host)
                except socket.gaierror:
                    print("[\033[91mDOC\033[00m] Host un-resolvable")
                    main()
                while True:
                    try:
                        sock = socket.socket(socket.AF_INET, socket.SOCK_STREAM)
                        ...
                        sys.stdout.write("\x1b]2;DOC |{}ms| STYLE\x07".format(stop))
                        print("DOC: {}:{} | Time: {}ms [\033[91mUP\033[00m]".format(ip, port, stop))
                        sock.close()
                        time.sleep(1)
                    except socket.error:
                        sys.stdout.write("\x1b]DOC |TIME OUT| STYLE\x07")
                        print("DOC: {}:{} [\033[91mDOWN\033[00m]".format(ip, port))
                        time.sleep(1)
                    except KeyboardInterrupt:
                        print("")
                        main()
            except ValueError:
                print("[\033[91mDOC\033[00m] The command {} requires an argument".format(sinput))
                main()
        elif sinput == "udp":
            if username == "guests":
                print("[\033[91mDOC\033[00m] You are not allowed to use this method")
                main()
            else:
                try:
                    ...
                    print("[\033[91mDOC\033[00m] Host: {} invalid".format(host))
                    main()
        elif sinput == "std":
            try:
                sinput, host, port, timer, pack = sin.split(" ")
            ...
            if what == "udp":
                ...
                while not udp:
                    if aid == 0:
                        print("[\033[91mDOS\033[00m] No udp Processes running.")
                        udp = True
                        main()
            if what == "icmp":
                ...
                icmp = False
                while not icmp:
                    print("[\033[91mDOC\033[00m] No ICMP processes running")
                    udp = True
                    main()
        else:
            print("[\033[91mDOC\033[00m] {} Not a command".format(sinput))
            main()
    ...
    if user == "root":
        if password == passwords[0]:
            ...
            try:
                ...
                print("\n[\033[91mDOC\033[00m] CTRL has been pressed")
                main()
        else:
            print("[+] Incorrect, exiting")
            exit()
